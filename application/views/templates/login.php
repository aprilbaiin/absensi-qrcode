        ...
        <div id="wrap" class="animsition">
            ...
            <div class="page page-core page-login">
                ...
                <div class="text-center">
                    <h4 style="color: white;"><span style="font-size: 24px;">APLIKASI PRESENSI SISWA DI SMKN 3 </span></h4>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="container w-420 p-15 bg-white mt-40 text-center">
                            ...
                            <form name="form" action="<?=base_url()?>login/doLogin" method="POST" class="form-validation mt-20" novalidate="">
